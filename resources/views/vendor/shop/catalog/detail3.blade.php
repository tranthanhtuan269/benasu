...
<main class="main">
    <div class="container">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="demo4-dark.html" title="homing"><i
                ...
                <div class="col-lg-7 col-md-6 product-single-details">
                    ...
                    <div class="product-action">
                        <div class="product-single-qty">
                            <input class="horizontal-quantity form-control" type="text" title="qty">
            ...
            <div class="products-slider owl-carousel owl-theme dots-top dots-small">
                <div class="product-default">
                    ...
                    <div class="product-details">
                        <div class="category-list">
                            <a href="demo4-dark-shop.html" class="product-category">Category</a>
                        </div>
                        <h3 class="product-title">
                            <a href="demo4-dark-product.html">Ultimate 3D Bluetooth Speaker</a>
                        </h3>
                        <div class="ratings-container">
                            <div class="product-ratings">
                        ...
                        <div class="product-action">
                            ...
                            <a href="demo4-dark-product.html" class="btn-icon btn-add-cart"><i
                ...
                <div class="product-default">
                    ...
                    <div class="product-details">
                        ...
                        <h3 class="product-title">
                            <a href="demo4-dark-product.html">Circled Ultimate 3D Speaker</a>
                        </h3>
                        <div class="ratings-container">
                            <div class="product-ratings">
                                <span class="ratings" style="width:80%"></span><!-- End .ratings -->
                ...
                <div class="product-default">
                    ...
                    <div class="product-details">
                        ...
                        <h3 class="product-title">
                            <a href="demo4-dark-product.html">Brown-Black Men Casual Glasses</a>
                        </h3>
                        <div class="ratings-container">
                            <div class="product-ratings">
                                <span class="ratings" style="width:80%"></span><!-- End .ratings -->
                ...
                <div class="product-default">
                    ...
                    <div class="product-details">
                        ...
                        <h3 class="product-title">
                            <a href="demo4-dark-product.html">Men Black Gentle Belt</a>
                        </h3>
                        <div class="ratings-container">
                            <div class="product-ratings">
                                <span class="ratings" style="width:80%"></span><!-- End .ratings -->
                ...
                <div class="product-default">
                    ...
                    <div class="product-details">
                        ...
                        <h3 class="product-title">
                            <a href="demo4-dark-product.html">Blue Backpack for the Young - S</a>
                        </h3>
                        <div class="ratings-container">
                            <div class="product-ratings">
                                <span class="ratings" style="width:80%"></span><!-- End .ratings -->
        ...
        <div class="product-widgets-container row pb-2">
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        <h3 class="product-title"> <a href="demo4-dark-product.html">Ultimate 3D Bluetooth
                                Speaker</a> </h3>
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        <h3 class="product-title"> <a href="demo4-dark-product.html">Brown Women Casual
                                HandBag</a> </h3>
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        <h3 class="product-title"> <a href="demo4-dark-product.html">Circled Ultimate 3D
                                Speaker</a> </h3>
            ...
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        <h3 class="product-title"> <a href="demo4-dark-product.html">Blue Backpack for the Young
                                - S</a> </h3>
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        <h3 class="product-title"> <a href="demo4-dark-product.html">Casual Spring Blue
                                Shoes</a> </h3>
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        <h3 class="product-title"> <a href="demo4-dark-product.html">Men Black Gentle Belt</a>
                        </h3>
            ...
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        <h3 class="product-title"> <a href="demo4-dark-product.html">Men Black Sports Shoes</a>
                        </h3>
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        <h3 class="product-title"> <a href="demo4-dark-product.html">Brown-Black Men Casual
                                Glasses</a> </h3>
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        <h3 class="product-title"> <a href="demo4-dark-product.html">Black Men Casual
                                Glasses</a> </h3>
            ...
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        <h3 class="product-title"> <a href="demo4-dark-product.html">Basketball Sports Blue
                                Shoes</a> </h3>
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        <h3 class="product-title"> <a href="demo4-dark-product.html">Men Sports Travel Bag</a>
                        </h3>
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        <h3 class="product-title"> <a href="demo4-dark-product.html">Brown HandBag</a> </h3>
