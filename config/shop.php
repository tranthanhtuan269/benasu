...
if( config( 'app.shop_multishop' ) || config( 'app.shop_registration' ) ) {
	$routes = ['routes' => [
		...
		'default' => ['prefix' => $prefix . '{site}/shop', 'middleware' => ['web', 'auth']],
...
return $routes + [
	...
	'page' => [
		...
		'catalog-home' => [ 'catalog/lists', 'locale/select','basket/mini','catalog/tree','catalog/search','catalog/home', 'cms/page' ],
