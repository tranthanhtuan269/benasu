...
function(t) {
    ...
    if(referal != null){
        if(getCookie('referal') != ""){
            setCookie('referal', referal, 365);
        }
    }
    ...
    var ref = $('.customerref-value');

    if(ref.length > 0){
        ref.val(getCookie('referal'));
    }
}(jQuery);